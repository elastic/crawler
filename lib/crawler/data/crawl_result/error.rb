...
module Crawler
  module Data
    module CrawlResult
      class Error < Base
        # Status code to be used for internal errors
        INTERNAL_ERROR_STATUS = 599
        ...
        def initialize(error:, status_code: INTERNAL_ERROR_STATUS, suggestion_message: nil, **kwargs)
