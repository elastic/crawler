    ...
    module CrawlResult
      class HTML < Success
        ...
        def meta_keywords(limit: 512)
          ...
          Crawler::Extraction::Utils.limit_bytesize(keywords, limit)
        end
        ...
        def meta_description(limit: 1024)
          ...
          Crawler::Extraction::Utils.limit_bytesize(description, limit)
        end
        ...
        def document_title(limit: 1000)
          ...
          title = Crawler::Extraction::Utils.node_descendant_text(title_tag)
          Crawler::Extraction::Utils.limit_bytesize(title, limit)
        end
        ...
        def document_body(limit: 5.megabytes)
          ...
          body_content = Crawler::Extraction::Utils.node_descendant_text(body_tag)
          Crawler::Extraction::Utils.limit_bytesize(body_content, limit)
        end
        ...
        def extract_by_selector(selector, ignore_tags)
          parsed_content.search(selector).map do |node|
            Crawler::Extraction::Utils.node_descendant_text(node, ignore_tags)
          end
        end
