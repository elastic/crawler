...
| [Ingest pipelines](./docs/features/INGEST_PIPELINES.md)                                                                                | Yes                       | [Yes](https://www.elastic.co/guide/en/enterprise-search/current/crawler-managing.html#crawler-managing-ingest-pipelines)      |
| [Binary content extraction](./docs/features/BINARY_CONTENT_EXTRACTION.md)                                                              | Yes                       | [Yes](https://www.elastic.co/guide/en/enterprise-search/current/crawler-managing.html#crawler-managing-binary-content)        |
| [Crawl rules](./docs/features/CRAWL_RULES.md) - allow/disallow specified URLs                                                          | Yes                       | [Yes](https://www.elastic.co/guide/en/enterprise-search/current/crawler-managing.html#crawler-managing-crawl-rules)           |
| [Extraction rules](./docs/features/EXTRACTION_RULES.md) - extraction using CSS, XPath, and URL selectors                               | Yes                       | [Yes](https://www.elastic.co/guide/en/enterprise-search/current/crawler-extraction-rules.html)                                |
| [Crawler directives](./docs/features/CRAWLER_DIRECTIVES.md) - `robots.txt`, sitemaps, robots meta tags, canonical URLs, nofollow links | Yes *                     | [Yes](https://www.elastic.co/guide/en/enterprise-search/current/crawler-content.html)                                         |
| [Scheduling](#scheduling-recurring-crawl-jobs)                                                                                         | Yes                       | [Yes](https://www.elastic.co/guide/en/enterprise-search/current/crawler-managing.html#crawler-managing-schedule)              |
