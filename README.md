...
*\*\*\* Event logs can be output to the shell or a logfile for Open Crawler, but they are currently not ingested into Elasticsearch. We intend to have event logs in Elasticsearch in `v0.3`.*
